...
builder.Services.Configure<BlobSetting>(builder.Configuration.GetSection("blobstorage"));
...
builder.Services.AddSingleton(
    ...
    sp =>{
        var bolbOption = sp.GetRequiredService<IOptions<BlobSetting>>();
...
builder.Services.AddSingleton<IimageStore, BlobImagesStore>();
